...
export function PuzzleCard() {
  ...
  return (
    <div
      className="overflow-hidden rounded-2xl border border-border bg-surface-card shadow-[0_16px_40px_rgba(21,27,24,0.06)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.5)] max-w-lg w-full transition-all duration-300">
      ...
      <div className="p-6 space-y-5">
        ...
        <div
          className="flex items-center justify-between rounded-xl border border-border bg-surface-2 p-4 shadow-inner">
        ...
        <div>
          <div
            className="flex items-center justify-between rounded-t-xl border border-border bg-surface-2 px-4 py-2.5 font-mono text-xs font-medium text-slate">
            <span className="flex items-center gap-1.5">
              <span
                className={`inline-block h-1.5 w-1.5 rounded-full ${nodes.sum || nodes.carry ? 'bg-signal-green' : 'bg-copper'}`}/>
              Circuit Workbench
            </span>
          ...
          <div
            className="relative overflow-hidden flex min-h-55 flex-col items-center justify-center rounded-b-xl border border-t-0 border-dashed border-border-strong bg-surface/10 text-center bg-[radial-gradient(var(--border-strong)_1px,transparent_1px)] bg-size-[20px_20px]">

            <div
              className="absolute inset-0 p-4 opacity-40 blur-[5px] scale-[1.02] select-none pointer-events-none transition-all duration-300">
              <svg viewBox="0 0 500 160" className="w-full h-auto stroke-2 fill-none stroke-round">
                ...
                <text x="120" y="84" className="font-mono text-[9px] font-bold fill-ink-soft text-center"
                      textAnchor="middle">G1
                </text>

                <rect x="220" y="30" width="40" height="40" rx="4" className="fill-surface-card stroke-border-strong"/>
                <text x="240" y="54" className="font-mono text-[9px] font-bold fill-ink-soft text-center"
                      textAnchor="middle">G2
                </text>

                <rect x="220" y="90" width="40" height="40" rx="4" className="fill-surface-card stroke-border-strong"/>
                <text x="240" y="114" className="font-mono text-[9px] font-bold fill-ink-soft text-center"
                      textAnchor="middle">G3
                </text>

                <rect x="340" y="55" width="40" height="40" rx="4" className="fill-surface-card stroke-border-strong"/>
                <text x="360" y="79" className="font-mono text-[9px] font-bold fill-ink-soft text-center"
                      textAnchor="middle">G4
                </text>

                <rect x="360" y="100" width="40" height="30" rx="4" className="fill-surface-card stroke-border-strong"/>
                <text x="380" y="119" className="font-mono text-[9px] font-bold fill-ink-soft text-center"
                      textAnchor="middle">G5
                </text>
