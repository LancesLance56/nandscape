...
function CreateBlockButton() {
  ...
  return (
    <button
      ...
      className="w-full rounded-lg border border-dashed border-border-strong px-2 py-2.5 text-[10px] font-semibold text-ink-soft transition-colors hover:border-copper/50 hover:bg-copper-bg/40 hover:text-copper-dark"
    >
...
function PaletteGroup({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-2 rounded-xl border border-border/60 bg-surface-2/40 p-2.5">
      <span className="whitespace-nowrap px-0.5 text-[11px] font-semibold text-slate">
        {title}
      </span>
