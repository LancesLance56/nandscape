        ...
        <div className="relative h-full w-full">
          {busData.values.map((v, i) => (
            <button
              ...
              style={{ top: `${verticalPos(i, width)}px` }}
              className={`absolute left-1/2 -translate-x-1/2 -translate-y-1/2 rounded px-1 font-mono text-sm font-bold leading-none transition-colors hover:bg-surface-2 active:scale-95 ${
