...
/**
 * The embedding reference, as a section rather than a page.
 *
 * It used to live at /embeds. Every tool on this page is embeddable, so the
 * instructions for embedding them belong under the list of them - two routes
 * meant a reader had to already know the second one existed. /embeds now
 * redirects here.
 *
 * The FAQ is exported because the page that mounts this also emits it as
 * structured data, and two copies of the same questions would drift.
 */

export const EMBEDS_FAQ = [
  {
...
export function EmbedsSection() {
  ...
  return (
    <section id="embeds" className="scroll-mt-24 border-t border-border pt-16">
        ...
        <h2 className="font-display text-2xl font-bold leading-tight text-ink">
          Embed these tools on your site
        </h2>
      ...
      <section className="mt-16">
        <h3 className="font-display text-lg font-bold text-ink">The URL shapes</h3>
        ...
        <h4 className="mt-8 font-display text-base font-bold text-ink">Options</h4>
      ...
      <section className="mt-16">
        <h3 className="font-display text-lg font-bold text-ink">oEmbed</h3>
      ...
      <section className="mt-16">
        <h3 className="font-display text-lg font-bold text-ink">Common questions</h3>
        <div className="mt-4 flex max-w-3xl flex-col gap-3">
          {EMBEDS_FAQ.map((entry) => (
            <details
              key={entry.question}
