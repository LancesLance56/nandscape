    ...
    <header className="fixed inset-x-0 top-0 z-50 h-12 border-b border-border bg-surface/95 backdrop-blur-md">
      <nav className="flex h-12 w-full items-center gap-3 px-4">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-3">
          {/* No Discuss link here: it lives in the workspace's action bar,
              next to Run and Submit, where it is in reach of the hand that is
              already there rather than back up in the chrome. */}
          <ThemeToggle />
